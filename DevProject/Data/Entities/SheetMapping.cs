namespace DevProject.Data.Entities
{
    ...
    public sealed class SheetMapping
    {
        ...
        public required List<ColumnMapping> ColumnMappings { get; init; }        public string? GroupByColumn { get; init; }        public List<SubArrayDefinition> SubArrayDefinitions { get; init; } = [];
